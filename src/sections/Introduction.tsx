export default function Introduction() {
  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen lg:h-screen flex flex-col-reverse pt-20 lg:flex-row items-center justify-center font-sans bg-red-200 select-none gap-10 lg:gap-0 flex-wrap py-10 lg:py-0">
